...
bg_gal_fbase = f"catalogs/Shape/cosmo_{cosmo_label:06d}/cosmo_{cosmo_label:06d}_run_0_kids_north_tomo{itomo+1}_wo_noise.txt"

bg_galcat = np.loadtxt(bg_gal_fbase, dtype=bgal_type)
...
w0 = cosmo_ccl.to_dict()['w0']
Om0 = cosmo_ccl.omega_x(1, 'matter')

rp_bins = np.linspace(0.1, 200, 32)
cosmology = FlatwCDM(H0=100*hubble, Om0=Om0, w0=w0)
lens_source_cut = 0.1
...
esd.write(f'aux/results/vlens/cosmo_000001_void_{catname}_tomo5_wrand.fits')
